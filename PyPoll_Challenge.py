...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > winning_count_county) and (county_vote_percentage > winning_percentage_county):
    ...
    # 7: Print the county with the largest turnout to the terminal.
        ...
        f"Largest Turnout Count: {winning_count_county:,}\n"
        f"Largest Percentage Turnout: {winning_percentage_county:.1f}%\n"
        f"-------------------------\n\n"
        f"Candidates Votes:\n"
        f"-------------------------\n")
